...
class Spectrometer:
    ...
    def __init__(self, cwd=""):
        ...
        self.REPORT_TEMPLATE_FILENAME = cwd + "Spectrometer_empty.docx"  # 实验报告模板（未填数据）的名称
        self.REPORT_OUTPUT_FILENAME = cwd + "../../Report/Experiment1/1071Report.docx"  # 最后生成实验报告的相对路径
