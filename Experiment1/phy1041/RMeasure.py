...
class RMeasure:
    ...
    def calc_data(self):
        ...
        u_ki = num_2ki * (sqrt(
            (u_r1/num_2r1)**2 + (u_mix/(num_2r0+num_2r1))**2 + (u_v/num_2v)**2 + (5.785/num_2rg)**2 + (u_d/num_2d)**2
        ))
